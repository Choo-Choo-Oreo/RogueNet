...
- [~] Storage screen art, 2026-09-25 (made by Claude, waiting on Foxy's review): in `resources/gfx/ui/storage/`, 10x10 ink icons for the tabs (`tab_all`, `tab_armour`, `tab_weapons`, `tab_jewellery`, `tab_back`, `tab_potions`, `tab_items`, `tab_materials`) and the toolbar (`tool_search`, `tool_sort`, `tool_sets`, `tool_store_all`), a 5x6 `lock` badge and `TabPaperDim` (the menu's ScrollPaper one shade darker, for tabs not chosen). The tabs and toolbar reuse the main menu's paper and rollers
