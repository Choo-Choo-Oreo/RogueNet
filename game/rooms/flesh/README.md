...
The 80 rooms have 865 spawn cells between them. The two peaceful organs and
...
80 rooms: each organ below, plus `<Organ>_Mutant`. Sizes are in the file
...
- **Tubes, 3 wide:** Pharynx (splits in two; mutant splits in three),
  ...
  Aorta.
- **Vessels and nerves, 1 wide:** Vein, Vein Fork, Artery, Capillaries,
  Spinal Cord.
