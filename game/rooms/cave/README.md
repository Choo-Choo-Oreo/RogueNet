...
The 72 rooms have 306 spawn cells between them.
...
- `tag_weights` are the same as flesh and forest:
  ...
  The old maze boost of 1.5 is gone. Only 8 of the 72 rooms are mazes now.
- `monsters` and `music` are unchanged: bat 3, blind rat 2, wolf 1, and
  Groovy.

## Current piece set (2026-09-24)

72 rooms: each formation below, plus `<Formation>_Deep`. Sizes are in the
...
- **Crawlways, 1 wide:** Crawlway, Squeeze, Keyhole.
- **Formations (combat):**
